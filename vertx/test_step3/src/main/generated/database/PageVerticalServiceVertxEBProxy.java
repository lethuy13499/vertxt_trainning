...
public class PageVerticalServiceVertxEBProxy implements PageVerticalService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public PageVerticalServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public PageVerticalServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
